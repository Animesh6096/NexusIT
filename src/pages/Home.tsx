            ...
            {[
              ...
              >
                ...
                <div className="relative p-8">
                  <div className="w-16 h-16 rounded-xl bg-primary flex items-center justify-center mb-6 shadow-lg group-hover:shadow-xl transition-shadow duration-300">
                    {service.icon}
                  </div>
                  ...
                  <div className="space-y-4">
                    <div>
                      <h3 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-1 group-hover:text-primary transition-colors duration-300">
                        {service.title}
                      </h3>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {service.features.map((feature, featureIndex) => (
                        <motion.span
                          ...
                          className="px-3 py-1 bg-gray-100 dark:bg-gray-700 text-xs font-medium text-gray-700 dark:text-gray-300 rounded-full group-hover:bg-primary/10 group-hover:text-primary transition-all duration-300"
                        >
                          {feature}
                        </motion.span>
                      ))}
